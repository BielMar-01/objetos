...
console.log(maiores.sort());


// Verifique se Baixo faz parte da lista de instrumentos e retorne true
const instrumentos = ['Guitarra', 'Baixos', 'Bateria', 'Teclado']
const nomes = instrumentos.some((item) => {
  return item === 'Baixo';
});
...
console.log('Valor total das compras foi de ' + valorTotal.toLocaleString('pt-br', {style: 'currency', currency: 'BRL'}));
